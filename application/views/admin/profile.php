    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="<?php echo base_url('admin') ?>" class="logo">
                ...
                <span class="logo-lg"><b>Staff User</b></span>
            </a>
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header">
                                    ...
                                    <?php } ?>
                                    <p>
                                        <?= $this->session->userdata('name') ?> - Finish Good
        ...
        <aside class="main-sidebar">
            ...
            <li><a href="<?php echo base_url('admin') ?>"><i class="fa fa-circle-o"></i> Dashboard v2</a></li>
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li class="active"><a href="<?= base_url('admin/tabel_barangmasuk') ?>"><i
                                        class="fa fa-circle-o"></i> Tabel Barang Masuk</a></li>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="box box-primary">
                            <div class="box-body box-profile">
                                ...
                                <p class="text-muted text-center">Staff - Finish Good</p><br>
                                ...
                                <div class="tab-pane active" id="settings">
                                    <form class="form-horizontal" action="<?= base_url('admin/proses_new_password') ?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="nik" name="nik" class="form-control" id="nik" disabled=""
                                                    value="<?= $this->session->userdata('nik') ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="new_password" class="col-sm-2 control-label">New
                                                Password</label>
                                        ...
                                        <div class="form-group">
                                            <label for="confirm_new_password" class="col-sm-2 control-label">Confirm New
                                                Password</label>
