...
<div class="container text-center" style="margin: 2em auto;">
    ...
    <a href="<?=base_url('report/barangKeluarManual')?>" style="margin-bottom:10px;float:left;" type="button"
        class="btn btn-danger" name="laporan_data"><i class="fa fa-file-text" aria-hidden="true"></i> Invoice Manual</a>
            ...
            <tbody>
                <tr>
                    ...
                    <td><a type="button" class="btn btn-danger btn-report"
                            ...
                            name="btn_report" style="margin:auto;"><i class="fa fa-file-text"
