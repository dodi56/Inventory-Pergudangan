...
class Report extends CI_Controller
{
  ...
  public function barangKeluarManual()
  {
    ...
    //header Data
    $pdf->SetHeaderData('outbox.png', 30, 'Laporan Data', 'Barang Keluar', array(203, 58, 44), array(0, 0, 0));
    ...
    $html =
      '<div>
        <h1 align="center">Invoice Bukti Barang Keluar</h1>
        <p>No Id Transaksi  :</p>
  ...
  public function barangKeluar()
  {
    ...
    $html =
      '<div>
        <h1 align="center">Invoice Bukti Barang Keluar</h1><br>
