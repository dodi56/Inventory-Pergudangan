    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="index2.html" class="logo">
                ...
                <span class="logo-mini"><b>Ya Kali</b></span>
                <!-- logo for regular state and mobile devices -->
                <span class="logo-lg"><b>Apaan</b>Tuh</span>
            </a>
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="<?php echo base_url() ?>pages/layout/boxed.html"><i class="fa fa-circle-o"></i>
                                    Boxed</a></li>
                            <li><a href="<?php echo base_url() ?>pages/layout/fixed.html"><i class="fa fa-circle-o"></i>
                                    Fixed</a></li>
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="<?php echo base_url() ?>pages/charts/morris.html"><i class="fa fa-circle-o"></i>
                                    Morris</a></li>
                            <li><a href="<?php echo base_url() ?>pages/charts/flot.html"><i class="fa fa-circle-o"></i>
                                    Flot</a></li>
                            <li><a href="<?php echo base_url() ?>pages/charts/inline.html"><i class="fa fa-circle-o"></i>
                                    Inline charts</a></li>
                        </ul>
                    </li>
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="<?php echo base_url() ?>pages/UI/general.html"><i class="fa fa-circle-o"></i>
                                    General</a></li>
                            <li><a href="<?php echo base_url() ?>pages/UI/icons.html"><i class="fa fa-circle-o"></i>
                                    Icons</a></li>
                            <li><a href="<?php echo base_url() ?>pages/UI/buttons.html"><i class="fa fa-circle-o"></i>
                                    Buttons</a></li>
                            <li><a href="<?php echo base_url() ?>pages/UI/sliders.html"><i class="fa fa-circle-o"></i>
                                    Sliders</a></li>
                            <li><a href="<?php echo base_url() ?>pages/UI/timeline.html"><i class="fa fa-circle-o"></i>
                                    Timeline</a></li>
                            <li><a href="<?php echo base_url() ?>pages/UI/modals.html"><i class="fa fa-circle-o"></i>
                                    Modals</a></li>
                        </ul>
                    </li>
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="<?php echo base_url() ?>pages/forms/general.html"><i class="fa fa-circle-o"></i>
                            ...
                            <li><a href="<?php echo base_url() ?>pages/forms/editors.html"><i class="fa fa-circle-o"></i>
                                    Editors</a></li>
                        </ul>
                    </li>
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="<?php echo base_url() ?>pages/tables/simple.html"><i class="fa fa-circle-o"></i>
                                    Simple tables</a></li>
                            <li><a href="<?php echo base_url() ?>pages/tables/data.html"><i class="fa fa-circle-o"></i>
                                    Data tables</a></li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="<?php echo base_url() ?>pages/examples/404.html"><i class="fa fa-circle-o"></i>
                                    404 Error</a></li>
                            <li><a href="<?php echo base_url() ?>pages/examples/500.html"><i class="fa fa-circle-o"></i>
                                    500 Error</a></li>
                            <li><a href="<?php echo base_url() ?>pages/examples/blank.html"><i class="fa fa-circle-o"></i> Blank Page</a></li>
                            <li><a href="<?php echo base_url() ?>pages/examples/pace.html"><i class="fa fa-circle-o"></i>
                                    Pace Page</a></li>
                        </ul>
                    </li>
                    <li class="treeview">
                            ...
                            <div class="box-body">
                                <div class="table-responsive">
                                    <table class="table no-margin">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><a href="<?php echo base_url() ?>pages/examples/invoice.html">OR9842</a>
                                                </td>
                                            ...
                                            <tr>
                                                <td><a href="<?php echo base_url() ?>pages/examples/invoice.html">OR1848</a>
                                                </td>
                                            ...
                                            <tr>
                                                <td><a href="<?php echo base_url() ?>pages/examples/invoice.html">OR7429</a>
                                                </td>
                                                <td>iPhone 6 Plus</td>
