                                        ...
                                        <div class="box-body">
                                            <?php foreach ($list_data as $d) { ?>
                                                ...
                                                <div class="form-group" style="display:block;">
                                                    ...
                                                    <input type="nik" name="nik" style="width:30%;margin-right: 67px;" class="form-control" id="nik" required="" value="<?= $d->nik ?>">
                                                </div>
                                                <div class="form-group" style="display:block;">
                                                    <label for="role" style="width:73%;">Role</label>
                                                    <select class="form-control" name="role" style="width:11%;margin-right: 18px;">
                                                        <?php if ($d->role == 1) { ?>
                                                            <option value="1" selected="">User Staff Gudang</option>
