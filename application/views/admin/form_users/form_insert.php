        ...
        <aside class="main-sidebar">
            ...
            <li><a href="<?php echo base_url('admin') ?>"><i class="fa fa-circle-o"></i> Dashboard v2</a></li>
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="<?= base_url('admin/form_barangmasuk') ?>"><i class="fa fa-circle-o"></i> Tambah
                    ...
                    <li class="treeview ">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="<?= base_url('admin/tabel_barangmasuk') ?>"><i class="fa fa-circle-o"></i> Tabel
                                    Barang Masuk</a></li>
                        ...
                        <div class="container">
                            ...
                            <div class="box box-primary" style="width:94%;">
                                <div class="box-header with-border">
                                    <h3 class="box-title"><i class="fa fa-fw fa-user" aria-hidden="true"></i> Tambah
                                        Users Data</h3>
                                </div>
                                <!-- /.box-header -->
                                <!-- form start -->
                                    ...
                                    <form action="<?= base_url('admin/proses_tambah_user') ?>" role="form" method="post">
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group" style="display:block;">
                                                ...
                                                <input type="text" name="nik" style="width:30%;margin-right: 67px;" class="form-control" id="nik" placeholder="NIK">
                                            </div>
                                            <div class="form-group" style="display:block;">
                                            ...
                                            <div class="form-group" style="display:block;">
                                                <label for="confirm_password" style="width:73%;">Confirm
                                                    Password</label>
